...
package com.apk.productInventory.filter;
...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		final String authorizationHeaderString = request.getHeader("Authorization");

		String username = null;
		String jwt = null;

		if (authorizationHeaderString != null && authorizationHeaderString.startsWith("Bearer ")) {
			jwt = authorizationHeaderString.substring(7);
